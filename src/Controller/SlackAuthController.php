...
class SlackAuthController extends OAuth2ControllerBase {
  ...
  public function __construct(MessengerInterface $messenger,
    ...
    parent::__construct('Social Auth Slack', 'social_auth_slack', $messenger, $network_manager, $user_authenticator, $slack_manager, $request, $data_handler);
  }
  ...
  public function callback() {
    ...
    if ($profile !== NULL) {
      ...
      return $this->userAuthenticator->authenticateUser($profile->getName(), $profile->getEmail(), $profile->getId(), $this->providerManager->getAccessToken(), $profile->getImage192(), $data);
    }
